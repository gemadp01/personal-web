    ...
    <main className="min-h-[80vh] flex justify-center items-center text-center">
      <section className="bg-gray-50 py-10 px-4 md:px-10 rounded-lg space-y-10">
        <div className="text-center space-y-6">
          {isSmallScreen ? (
            <h1 className="space-y-5">Contact</h1>
          ) : (
            <h4 className="space-y-3">Contact</h4>
          )}
        ...
        <div className="flex justify-start space-x-4 mt-6">
          ...
          <a
            ...
            className="group bg-gray-200 hover:bg-dark p-2 rounded-lg transition"
          >
            <GitHubLogoIcon className="w-5 h-5 text-primary group-hover:text-secondary" />
          </a>
          <a
            ...
            className="group bg-gray-200 hover:bg-dark p-2 rounded-lg transition"
          >
            <LinkedInLogoIcon className="w-5 h-5 text-primary group-hover:text-secondary" />
          </a>
        </div>
      </section>
    </main>
